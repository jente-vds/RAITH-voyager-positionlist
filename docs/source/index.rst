...
This Python package is meant to mitigate this and allow users to create positionlist from behind their own computer. The package is designed to work with `gdstk <https://github.com/heitzmann/gdstk>`_, a package for creating GDSII files. It can also work with the deprecated package `gdspy <https://github.com/heitzmann/gdspy>`_, however, its usage is not advised.
